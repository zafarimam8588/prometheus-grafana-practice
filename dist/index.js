...
const activeRequest_1 = require("./metrics/activeRequest");
const requestTime_1 = require("./metrics/requestTime");
const app = (0, express_1.default)();
app.use(express_1.default.json());
app.use(requestCount_1.requestCountMiddleware);
app.use(activeRequest_1.cleanupMiddleware);
app.use(requestTime_1.Totaltimemiddleware);
